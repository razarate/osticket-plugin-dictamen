...
extends ModelResultSet {
     ...
     */
    function getIterator(): ArrayIterator {
        // Utiliza parent::getIterator() que retorna un iterador
        $filtered = new CallbackFilterIterator(parent::getIterator(),
            function($i) { 
                return !$i->__deleted__;  // Filtra elementos marcados como eliminados
            }
        );
        
        // Convierte el CallbackFilterIterator en un array y luego en ArrayIterator
        return new ArrayIterator(iterator_to_array($filtered));
    }
