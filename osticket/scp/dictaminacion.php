...
require_once(INCLUDE_DIR . 'class.nav.php'); // Asegúrate de que la ruta sea correcta
...
<?php
    ...
    echo "<p>Verifique que haya instalado correctamente el plugin de Dictaminación y este activo</p>";
}
